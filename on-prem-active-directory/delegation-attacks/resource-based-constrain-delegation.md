...
#### [New Concepts](https://book.hacktricks.wiki/en/windows-hardening/active-directory-methodology/resource-based-constrained-delegation.html#new-concepts) <a href="#new-concepts" id="new-concepts"></a>
...
#### [Attack structure](https://book.hacktricks.wiki/en/windows-hardening/active-directory-methodology/resource-based-constrained-delegation.html#attack-structure) <a href="#attack-structure" id="attack-structure"></a>
...
### [Attack](https://book.hacktricks.wiki/en/windows-hardening/active-directory-methodology/resource-based-constrained-delegation.html#attack) <a href="#attack" id="attack"></a>

#### [Creating a Computer Object](https://book.hacktricks.wiki/en/windows-hardening/active-directory-methodology/resource-based-constrained-delegation.html#creating-a-computer-object) <a href="#creating-a-computer-object" id="creating-a-computer-object"></a>
...
#### [Configuring Resource-based Constrained Delegation](https://book.hacktricks.wiki/en/windows-hardening/active-directory-methodology/resource-based-constrained-delegation.html#configuring-resource-based-constrained-delegation) <a href="#configuring-resource-based-constrained-delegation" id="configuring-resource-based-constrained-delegation"></a>
...
#### [Performing a complete S4U attack](https://book.hacktricks.wiki/en/windows-hardening/active-directory-methodology/resource-based-constrained-delegation.html#performing-a-complete-s4u-attack) <a href="#performing-a-complete-s4u-attack" id="performing-a-complete-s4u-attack"></a>
...
#### [Accessing](https://book.hacktricks.wiki/en/windows-hardening/active-directory-methodology/resource-based-constrained-delegation.html#accessing) <a href="#accessing" id="accessing"></a>
...
#### [Abuse different service tickets](https://book.hacktricks.wiki/en/windows-hardening/active-directory-methodology/resource-based-constrained-delegation.html#abuse-different-service-tickets) <a href="#abuse-different-service-tickets" id="abuse-different-service-tickets"></a>

Lear about the [**available service tickets here**](https://book.hacktricks.wiki/en/windows-hardening/active-directory-methodology/silver-ticket.html#available-services).

### [Kerberos Errors](https://book.hacktricks.wiki/en/windows-hardening/active-directory-methodology/resource-based-constrained-delegation.html#kerberos-errors) <a href="#kerberos-errors" id="kerberos-errors"></a>
...
### [References](https://book.hacktricks.wiki/en/windows-hardening/active-directory-methodology/resource-based-constrained-delegation.html#references) <a href="#references" id="references"></a>
